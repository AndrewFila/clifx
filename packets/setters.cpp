...
WaveformPayload::WaveformPayload()
    : transient(false), period(0), cycles(0.0F), skew_ratio(0), waveform(0), reserved(0) {
}
...
WaveformOptionalPayload::WaveformOptionalPayload()
    : transient(false), period(0), cycles(0.0F), skew_ratio(0), waveform(0), set_hue(false),
      set_saturation(false), set_brightness(false), set_kelvin(false), reserved(0) {
}
...
ColorZonesPayload::ColorZonesPayload() : start_index(0), end_index(0), duration(0), apply(0) {
}
...
Set64Payload::Set64Payload()
    : tile_index(0), length(0), x(0), y(0), width(0), duration(0), colors{}, reserved(0) {
}
...
CopyFrameBufferPayload::CopyFrameBufferPayload()
    : tile_index(0), length(0), src_fb_index(0), dst_fb_index(0), src_x(0), src_y(0), dst_x(0),
      dst_y(0), width(0), height(0), duration(0), reserved(0) {
}
