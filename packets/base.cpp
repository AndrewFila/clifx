...
Tile::Tile()
    : accel_meas_x(0), accel_meas_y(0), accel_meas_z(0), user_x(0.0F), user_y(0.0F), width(0),
      height(0), device_version_vendor(0), device_version_product(0), firmware_build(0),
      firmware_version_minor(0), firmware_version_major(0), reserved1(0), reserved2(0),
...
FrameHeader::FrameHeader()
    : size(0), protocol(LIFX_PROTOCOL), addressable(true), tagged(false), origin(0), source(0) {
}
...
FrameAddress::FrameAddress()
    : target(0), res_required(false), ack_required(false), sequence(0), reserved1{}, reserved2(0) {
}
